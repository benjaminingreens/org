...
```bash
pip install "git+https://github.com/benjaminingreens/org.git@v0.1.9"
```
...
~/.venvs/org/bin/pip install "git+https://github.com/benjaminingreens/org.git@v0.1.9"
...
To update, run:
```bash
~/.venvs/org/bin/pip install -U "git+https://github.com/benjaminingreens/org.git@v0.1.9"
```
